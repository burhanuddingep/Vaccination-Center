...
(function ($, Drupal,drupalSettings) {
    ...
    Drupal.behaviors.olivero_base_theme = {
        attach: function (context, settings) {
            once('olivero_base_theme', 'input.olivero_base_theme', context).forEach(
                function (element) {
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                if(result.data == 1) {
                                    ...
                                    $(".register-link").attr('value', 'Already registered');
                                }
                            },
                        ...
                        $(".register-link").one('click', function () { 
                                ...
                                success: function (data) {
                                    if(data.result) {
                                        ...
                                        if($(".register-link .register-success").length < 1) {
                                            $(".register-link").after("<h3 class='register-success'>Registered Successfully!</h3>");
                                        }
                                        $(".register-link").attr('disabled','disabled');
                                        $(".register-link").attr('value', 'Already registered');
